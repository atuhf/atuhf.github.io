...
const msgToTraditionalChinese = translate.msgToTraditionalChinese; /* 此处可以更改为你想要显示的文字 */
const msgToSimplifiedChinese = translate.msgToSimplifiedChinese; /* 同上，但两处均不建议更改 */
